...
#define FRAME_HEIGHT 72  // 16:9 aspect ratio
...
bool loadMediaFile(const std::string& filename) {
    ...
    size_t bytesPerFrame = FRAME_WIDTH * FRAME_HEIGHT;  // 9216 bytes per frame for 128x72
...
int main() {
    ...
    // Create window
    int windowWidth = FRAME_WIDTH * WINDOW_SCALE;  // 1024 pixels wide
    int windowHeight = FRAME_HEIGHT * WINDOW_SCALE;  // 576 pixels high (16:9 ratio)
